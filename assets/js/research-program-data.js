(() => {
  ...
  const DATA = {
    ...
    proj_target: {kind:"project",title:"The Caliphate’s Target Map",summary:"Ethnosectarian composition and insurgent violence in Iraq.",bullets:["Academic research · May 2026"],methods:["Spatial statistics","Network analysis","Data visualization"],work:["The Caliphate’s Target Map"],url:REPOS.targetMap,output:"Academic research paper",status:"Published · May 2026",evidenceLabel:"GitHub repository"},
    proj_lethality: {kind:"project",title:"Estimating Lethality Under Missing Casualty Data",summary:"Suicide attacks in Islamic State-linked terrorism under incomplete casualty records.",bullets:["Academic research · May 2026"],methods:["Missing-data methods","Multiple imputation","PCA"],work:["Estimating Lethality Under Missing Casualty Data"],url:REPOS.lethality,output:"Academic research paper",status:"Published · May 2026",evidenceLabel:"Research record"},
    proj_vanguards: {kind:"project",title:"Vanguards of Terror",summary:"Strategic and tactical orientation and cohesion of the Islamic State insurgency, 1999–2019.",bullets:["Honors thesis · May 2022"],methods:["Network analysis","Content analysis","Longitudinal analysis"],work:["Vanguards of Terror"],url:REPOS.vanguards,output:"Honors thesis",status:"Published · May 2022",evidenceLabel:"Institutional repository"},
    proj_climate: {kind:"project",title:"The Effects of Climate Change on Terrorist Networks",summary:"Environmental change, resource stress, recruitment, and terrorist-network development in MENA.",bullets:["Published research · Dec. 2022"],methods:["Spatial statistics","Scenario comparison","Human ecology"],work:["The Effects of Climate Change on Terrorist Networks"],url:REPOS.climateTerror,output:"Research article",status:"Published · Dec. 2022",evidenceLabel:"Published article"},
    proj_flood: {kind:"project",title:"Himalayan Flood Response",summary:"Humanitarian access and response effectiveness along the Nepalese-Chinese border.",bullets:["Applied humanitarian analysis"],methods:["Spatial statistics","Operational analysis"],work:["Himalayan Flood Response"],url:REPOS.floodResponse,output:"Applied humanitarian analysis",status:"Public case study forthcoming",evidenceLabel:"Research record"},
    proj_food: {kind:"project",title:"Food Under Fire",summary:"Conflict-driven food insecurity, humanitarian access, and civilian protection.",bullets:["UN-facing applied research"],methods:["Forecasting","Humanitarian analysis","Decision support"],work:["Food Under Fire"],url:REPOS.foodUnderFire,output:"UN-facing analytical product",status:"Public materials forthcoming",evidenceLabel:"Research record"},
    proj_aid: {kind:"project",title:"Protecting Aid Workers",summary:"Threats to humanitarian personnel, operating access, and protection in conflict environments.",bullets:["UN-facing applied research"],methods:["Human-security analysis","Text analysis","Natural language processing"],work:["Protecting Aid Workers"],url:REPOS.protectingAidWorkers,output:"UN-facing analytical product",status:"Public materials forthcoming",evidenceLabel:"Research record"},
    proj_ai: {kind:"project",title:"Artificial Intelligence Non-Proliferation at the United Nations",summary:"AI non-proliferation across the UN and multilateral ecosystem.",bullets:["Applied emerging-technology research"],methods:["Network analysis","Dimensionality reduction","Unsupervised learning","Natural language processing"],work:["Artificial Intelligence Non-Proliferation at the United Nations"],url:REPOS.aiNonproliferation,output:"Applied emerging-technology analysis",status:"Public materials forthcoming",evidenceLabel:"GitHub repository"},
    proj_autonomous: {kind:"project",title:"Countering Autonomous Weapons Proliferation",summary:"Proliferation risks from increasingly accessible autonomous systems and enabling technologies.",bullets:["Applied human-security research"],methods:["Network analysis","Forecasting","Bayesian methods"],work:["Countering Autonomous Weapons Proliferation"],url:REPOS.autonomousWeapons,output:"Applied human-security analysis",status:"Public summary forthcoming",evidenceLabel:"Research record"},
    proj_ambassador: {kind:"project",title:"Statistical Analysis for Ambassador-Level Advising",summary:"Releasable descriptions of quantitative analysis supporting senior multilateral decision-making.",bullets:["Decision support"],methods:["Statistical computing","Model validation","Forecasting"],work:["Statistical Analysis for Ambassador-Level Advising"],url:REPOS.ambassadorAdvising,output:"Statistical decision support",status:"Releasable examples only",evidenceLabel:"Research record"}
  };
