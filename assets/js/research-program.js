(() => {
  ...
  const DATA = {
    ...
    "q-latent": {
      ...
      questions: ["Which structures emerge from the observations themselves rather than from analyst-defined categories?"],
    ...
    "q-labels": {
      ...
      questions: ["How can statistical models remain useful without treating disputed categories as unquestioned ground truth?"],
    ...
    "q-diffusion": {
      ...
      questions: ["What process evidence is needed to distinguish diffusion from parallel adoption, common exposure, or coincidence?"],
    ...
    "q-change": {
      ...
      questions: ["How can substantive movement be separated from arbitrary orientation, scaling, sampling variation, and changing entity sets?"],
